// Ejercicio 16-18.
const students = [
    { id: 1, name: 'Andy', note: 12 },
    { id: 2, name: 'Rosmery', note: 20 },
    { id: 3, name: 'Armando', note: 19 },
    { id: 4, name: 'Brenda', note: 8 },
    { id: 5, name: 'William', note: 18 }
];
...
const populateTable = () => {
    ...
    students.forEach(student => {
        ...
        ['name', 'note'].forEach(key => {
            const cell = document.createElement('td');
            if (key === 'note') cell.textContent = Number(student[key]);
            else cell.textContent = student[key];
            row.appendChild(cell);
        });
